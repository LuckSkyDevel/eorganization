...
public class ProjetoController {
    ...
    public ProjetoController(ProjetoService service, MembroService membroService) {
    ...
    @PostMapping("/membro")
    @PreAuthorize("hasAnyRole('ADMIN', 'GERENTE')")
    public ResponseEntity<MembroDTO> adicionaMembroProjeto(@Valid @RequestBody CreateMembroDTO dto) {
